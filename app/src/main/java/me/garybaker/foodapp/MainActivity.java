...
import java.util.Map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnPost = (Button) findViewById(R.id.postData);
        final EditText textPost = (EditText) findViewById(R.id.postText);
...
//                    hello.setText((CharSequence) user);
        ...
        btnPost.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                writeNewPost(mAuth.getUid(), mAuth.getCurrentUser().getDisplayName(), "blah", "yooozaaaa");
            }
        });
